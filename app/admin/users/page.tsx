  ...
  if (currentUserProfile?.role !== 'admin') {
    return (
      <div className="max-w-4xl mx-auto mt-20 p-12 bg-white rounded-[2.5rem] border border-slate-100 shadow-xl text-center">
        ...
        <p className="text-slate-500 text-lg mb-8">Only administrators have permission to manage firm users and access levels.</p>
        <button
          ...
          <form onSubmit={handleCreateUser} className="grid md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none transition-all placeholder:text-slate-300 font-medium"
                value={fullName}
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none transition-all placeholder:text-slate-300 font-medium font-mono"
                value={password}
            ...
            <div className="space-y-3">
              ...
              <select
                className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none transition-all font-bold text-slate-700 appearance-none cursor-pointer"
                value={role}
