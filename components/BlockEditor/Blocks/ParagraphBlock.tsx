    ...
    return (
        <div className="w-full relative group">
            ...
            <div
                ...
                className="w-full min-h-[1.5em] bg-transparent border-none focus:ring-0 outline-none text-slate-700 leading-relaxed placeholder:text-slate-300 empty:after:content-['Type_/_for_menu...'] empty:after:text-slate-300 transition-all duration-200"
                style={{
